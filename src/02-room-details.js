...
function getRoomByDinosaurName(dinosaurs, rooms, dinosaurName) {
  let dinoId = null;
  const noDinosaur = `Dinosaur with name '${dinosaurName}' cannot be found.`
 ...
 */
    function getConnectedRoomNamesById(rooms, roomId) {
      // Find the initial room by ID
